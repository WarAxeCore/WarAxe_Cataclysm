...
public:
    ...
    static bool HandleNpcAddCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (chr->GetTransport())
        {
            ...
            if (tguid > 0)
            {
                PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_INSERT_CREATURE_TRANSPORT);
    ...
    static bool HandleNpcAddMoveCommand(ChatHandler* handler, const char* args)
    {
        ...
        */
        ...
        PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_UPDATE_CREATURE_MOVEMENT_TYPE);
    ...
    static bool HandleNpcSetFactionIdCommand(ChatHandler* handler, const char* args)
    {
        ...
        // ..and DB
        PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_UPDATE_CREATURE_FACTION);
    ...
    static bool HandleNpcSetFlagCommand(ChatHandler* handler, const char* args)
    {
        ...
        PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_UPDATE_CREATURE_NPCFLAG);
    ...
    static bool HandleNpcMoveCommand(ChatHandler* handler, const char* args)
    {
        ...
        PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_UPDATE_CREATURE_POSITION);
    ...
    static bool HandleNpcPlayEmoteCommand(ChatHandler* handler, const char* args)
    {
        ...
        {
            PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_UPDATE_CREATURE_TRANSPORT_EMOTE);
    ...
    */
    ...
    static bool HandleNpcSetSpawnDistCommand(ChatHandler* handler, const char* args)
    {
        ...
        PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_UPDATE_CREATURE_SPAWN_DISTANCE);
    ...
    static bool HandleNpcSetSpawnTimeCommand(ChatHandler* handler, const char* args)
    {
        ...
        PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_UPDATE_CREATURE_SPAWN_TIME_SECS);
    ...
    static bool HandleNpcTameCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        // caster have pet now
        player->SetMinion(pet, true, PET_SAVE_AS_CURRENT);
    ...
    static bool HandleNpcAddFormationCommand(ChatHandler* handler, const char* args)
    {
        ...
        PreparedStatement* stmt = WorldDatabase.GetPreparedStatement(WORLD_INSERT_CREATURE_FORMATION);
