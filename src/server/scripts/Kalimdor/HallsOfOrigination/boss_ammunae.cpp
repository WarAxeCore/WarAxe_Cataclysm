...
public:
	...
	struct boss_ammunaeAI : public BossAI
	{
		...
		{
			me->BossYell("Wither away!", 18573);
		}

		void JustDied(Unit* /*Kill*/)
		{
			_JustDied();
			me->BossYell("The cycle continues...", 18569);
		}

		void EnterCombat(Unit* /*Ent*/)
		{
			me->BossYell("This chamber will flourish with your life energy!", 18571);
		...
		void UpdateAI(const uint32 diff)
		{
			...
			{
				me->BossYell("Your life, UNLEASHED!", 18572);
...
public:
	...
	struct npc_ammunae_seedling_podAI : public Scripted_NoMovementAI
	{
		...
		void Reset()
		{
			...
			if (Creature* pAmmunae = me->FindNearestCreature(BOSS_AMMUNAE, 100.0f, true))
