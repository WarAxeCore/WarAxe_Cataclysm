...
public:
	...
	struct boss_earthrager_ptahAI : public BossAI
	{
		...
		{
			me->BossYell("More carrion for the swarm...", 18906);
		...
		{
			_JustDied();
			me->BossYell("Ptah... is... no more...", 18905);
			instance->SetBossState(DATA_EARTHRAGER_PTAH, DONE);
		}

		void KilledUnit(Unit* /*p_Who*/)
		{
			me->BossYell("Dust to dust...", 18907);
		}
