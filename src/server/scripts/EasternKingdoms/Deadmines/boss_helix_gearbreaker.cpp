...
public:
	...
	struct boss_helix_gearbreakerAI : public BossAI
	{
		...
		void EnterCombat(Unit* /*who*/)
		{
			...
			me->BossYell("The mistress will pay me handsomely for your heads!", 20849);
			DoZoneInCombat();
		...
		{
			me->BossYell("Only 10 copper!? You're not even worth killing!", 20845);
		}
		...
		void UpdateAI(const uint32 diff)
		{
			...
			if (!me->GetVehicle())
				...
				{
					me->BossYell("I didn't need him! Not when i've got YOU oafs!", 20846);
