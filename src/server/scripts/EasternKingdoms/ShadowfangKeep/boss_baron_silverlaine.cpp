...
#define SAY_KILL2 "May you rest in peace."
...
public:
	...
	{
		boss_baron_silverlaineAI(Creature* pCreature) : BossAI(pCreature, DATA_BARON_SILVERLAINE)
		{
		...
		void EnterCombat(Unit* /*pWho*/)
		{
			...
			DoZoneInCombat();
			instance->SetBossState(DATA_BARON_SILVERLAINE, IN_PROGRESS);
		}
...
public:
	...
	struct npc_silverlaine_worgenAI : public ScriptedAI
	{
		...
		{
			if (Creature* _silverlaine = me->FindNearestCreature(BOSS_BARON_SILVERLAINE, 200.0f))
		...
		{
			if (pInstance && pInstance->GetBossState(DATA_BARON_SILVERLAINE) != IN_PROGRESS)
