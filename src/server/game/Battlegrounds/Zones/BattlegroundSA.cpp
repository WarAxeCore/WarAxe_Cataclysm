...
BattlegroundSA::BattlegroundSA()
{
    ...
    //! This is here to prevent an uninitialized variable warning
...
void BattlegroundSA::CaptureGraveyard(BG_SA_Graveyards i, Player* Source)
{
    ...
    if (!sg)
    {
        sLog->outError("ERROR: BattlegroundSA::CaptureGraveyard: non-existent GY entry: %u", BG_SA_GYEntries[i]);
        return;
    }
